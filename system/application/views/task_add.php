...
<table width="100%"  id="active_tasks" class="table_tasks" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td>
            ...
            <select id="task_for" name="task_for">
                ...
                <option value="<?=$user_data->users_id?>"><?=$user_data->users_login?> (<?=$user_data->users_name?>)</option>
                <?php endforeach; ?>
            </select>
            <?php else: ?>
            <select id="task_for" name="task_for">
    ...
    <tr>
        ...
        <td>
            <input type="text" id="task_name" name="task_name" size="36" value="<?=set_value('task_name'); ?>">
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <textarea id="task_description" name="task_description" cols="36" rows="16"><?=set_value('task_description'); ?></textarea>
    ...
    <tr>
        ...
        <td>
            <input type="text" id="date_start" name="date_start" size="36" value="<?=set_value('date_start', date('d-m-Y', now())); ?>">  - Время: <input type="text" id="start_time" name="start_time" size="8" value="<?=set_value('start_time', date('H:i', now())); ?>">
            <script>
    ...
    <tr>
        ...
        <td>
            <input type="text" id="date_end" name="date_end" size="36" value="<?=set_value('date_end', date('d-m-Y', now())); ?>"> - Время: <input type="text" id="end_time" name="end_time" size="8" value="<?=set_value('end_time', date('H:i', now())); ?>">
            <script>
                $('.date-pick').datePicker({startDate:'2010-01-01', clickInput:true});
            </script>
