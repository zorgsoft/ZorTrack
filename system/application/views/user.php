...
<div class="main_content">
    ...
    <div align="center"><form action="<?=base_url().'user_edit/'.$user_id;?>"><input type="submit" value="Редактировать"></form><br><br>
    Отработанно ({user_closed_days} дней - {user_closed_hours} часов, {user_closed_minutes} минут)
    </div>
    <br><br>
